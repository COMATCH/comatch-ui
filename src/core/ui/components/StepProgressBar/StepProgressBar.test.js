...
describe('StepProgressBar tests', () => {
    ...
    describe('verifying the HTML structure', () => {
        it('should render correctly right numbers of nodes/dom elements', () => {
            ...
            expect(stepProgressBarComponent.find('.StepProgressBar__line').at(1)
                .hasClass('StepProgressBar__line')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__progress').at(2)
                .hasClass('StepProgressBar__progress')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__step').at(2)
                .hasClass('StepProgressBar__step StepProgressBar__step1')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__circle').at(4)
                .hasClass('StepProgressBar__circle')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__step-text').at(5)
                .hasClass('StepProgressBar__step-text')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__step').at(5)
                .hasClass('StepProgressBar__step StepProgressBar__step2')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__circle').at(7)
                .hasClass('StepProgressBar__circle')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__step-text').at(8)
                .hasClass('StepProgressBar__step-text')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__step').at(8)
                .hasClass('StepProgressBar__step StepProgressBar__step3')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__circle').at(10)
                .hasClass('StepProgressBar__circle')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__step-text').at(11)
                .hasClass('StepProgressBar__step-text')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__step').at(11)
                .hasClass('StepProgressBar__step StepProgressBar__step4 active')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__circle').at(13)
                .hasClass('StepProgressBar__circle')).toBe(true);
            expect(stepProgressBarComponent.find('.StepProgressBar__step-text').at(14)
                .hasClass('StepProgressBar__step-text')).toBe(true);
        });
